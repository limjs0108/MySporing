...
public class TeamVO {
	...
	public String getTeam_creatAt() {
		return team_creatAt;
	}
	public void setTeam_creatAt(String team_creatAt) {
		this.team_creatAt = team_creatAt;
	}
	...
	public TeamVO(int team_num, String team_category, String team_grade, String team_gender, String team_match_way,
			String team_ground_name, String team_ground_addr, String team_game_date, String team_start_time,
			String team_end_time, String team_fee, String team_content, String team_user, String team_creatAt,
			String team_status) {
		super();
		this.team_num = team_num;
		this.team_category = team_category;
